...
BOOST_AUTO_TEST_CASE(core_007)
{
	using namespace cyng;
	BOOST_CHECK(test_core_007());
}
BOOST_AUTO_TEST_CASE(core_008)
{
	using namespace cyng;
	BOOST_CHECK(test_core_008());
}
...
BOOST_AUTO_TEST_CASE(store_005)
{
	using namespace cyng;
	BOOST_CHECK(test_store_005());
}
BOOST_AUTO_TEST_CASE(store_006)
{
	using namespace cyng;
