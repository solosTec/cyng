...
namespace cyng {
    ...
    namespace utf8 {
        ...
        /**
         * Integral type that can hold a Unicode code point
         */
         ...
         */
        template <typename BaseIterator> class u8_to_u32_iterator {
          ...
          public:
            ...
            bool equals(u8_to_u32_iterator const &pos) const { return this->pos_ == pos.pos_; }

            friend bool operator==(u8_to_u32_iterator const &i1, u8_to_u32_iterator const &i2) { return i1.equals(i2); }
            friend bool operator!=(u8_to_u32_iterator const &i1, u8_to_u32_iterator const &i2) { return !i1.equals(i2); }
        ...
        template <typename BaseIterator> class u32_to_u8_iterator {
          ...
          public:
            ...
            bool equals(u32_to_u8_iterator const &pos) const { return this->pos_ == pos.pos_; }

            friend bool operator==(u32_to_u8_iterator const &i1, u32_to_u8_iterator const &i2) { return i1.equals(i2); }
            friend bool operator!=(u32_to_u8_iterator const &i1, u32_to_u8_iterator const &i2) { return !i1.equals(i2); }
        ...
        constexpr std::uint32_t utf8_byte_count(std::uint8_t c) {
            ...
            case 0xC0: return 2; // 110x_xxxx 10xx_xxxx
            case 0xE0: return 3; // 1110_xxxx 10xx_xxxx 10xx_xxxx
            case 0xF0: return 4; // 1111_0xxx 10xx_xxxx 10xx_xxxx 10xx_xxxx
            default: break;
            }
            return 1; // 0xxx_xxxx
        }
