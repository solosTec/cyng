    ...
    namespace db {
        namespace sqlite {
            namespace detail {
                ...
                template <> object get_value<bool>(sqlite3_stmt *stmt, int index) {
                    const bool result = (::sqlite3_column_int(stmt, index) == 1);
                    return make_object(result);
                }

                template <> object get_value<std::int8_t>(sqlite3_stmt *stmt, int index) {
...
#ifdef _DEBUG_DB
                        std::cerr << "get_value<std::int8_t>(" << n << ") " << ex.what() << std::endl;
#endif
                    }
                    return make_object<std::int8_t>(0);
                }

                template <> object get_value<std::uint8_t>(sqlite3_stmt *stmt, int index) {
                    auto const n = sqlite3_column_int(stmt, index);
                    try {
                        return make_object(boost::numeric::converter<std::uint8_t, int>::convert(n));
                    } catch (boost::bad_numeric_cast const ex) {
#ifdef _DEBUG_DB
                        std::cerr << "get_value<std::uint8_t>(" << n << ", index " << index << ") " << ex.what() << std::endl;
#endif
                    }
                    return make_object<std::uint8_t>(0);
                }

                template <> object get_value<std::int16_t>(sqlite3_stmt *stmt, int index) {
                    auto const n = sqlite3_column_int(stmt, index);
                    try {
                        return make_object(boost::numeric::converter<std::int16_t, int>::convert(n));
                    } catch (boost::bad_numeric_cast const ex) {
#ifdef _DEBUG_DB
                        std::cerr << "get_value<std::int16_t>(" << n << ", index " << index << ") " << ex.what() << std::endl;
#endif
                    }
                    return make_object<std::int16_t>(0);
                }

                template <> object get_value<std::uint16_t>(sqlite3_stmt *stmt, int index) {
                    auto const n = sqlite3_column_int(stmt, index);
                    try {
                        return make_object(boost::numeric::converter<std::uint16_t, int>::convert(n));
                    } catch (boost::bad_numeric_cast const ex) {
#ifdef _DEBUG_DB
                        std::cerr << "get_value<std::uint16_t>(" << n << ", index " << index << ") " << ex.what() << std::endl;
#endif
                    }
                    return make_object<std::uint16_t>(0);
                }

                template <> object get_value<std::int32_t>(sqlite3_stmt *stmt, int index) {
                    auto const n = sqlite3_column_int(stmt, index);
                    try {
                        return make_object(boost::numeric::converter<std::int32_t, int>::convert(n));
                    } catch (boost::bad_numeric_cast const ex) {
#ifdef _DEBUG_DB
                        std::cerr << "get_value<std::int32_t>(" << n << ", index " << index << ") " << ex.what() << std::endl;
#endif
                    }
                    return make_object<std::int32_t>(0);
                }

                template <> object get_value<std::uint32_t>(sqlite3_stmt *stmt, int index) {
                    auto const n = sqlite3_column_int(stmt, index);
                    try {
                        return make_object(boost::numeric::converter<std::uint32_t, int>::convert(n));
                    } catch (boost::bad_numeric_cast const ex) {
#ifdef _DEBUG_DB
                        std::cerr << "get_value<std::uint32_t>(" << n << ", index " << index << ") " << ex.what() << std::endl;
#endif
                    }
                    return make_object<std::uint32_t>(0);
                }

                template <> object get_value<std::int64_t>(sqlite3_stmt *stmt, int index) {
                    return make_object<std::uint64_t>(sqlite3_column_int64(stmt, index));
                }

                template <> object get_value<std::uint64_t>(sqlite3_stmt *stmt, int index) {
                    auto const n = sqlite3_column_int64(stmt, index);
                    try {
                        return make_object(boost::numeric_cast<std::uint64_t>(n));
                    } catch (boost::bad_numeric_cast const ex) {
#ifdef _DEBUG_DB
                        std::cerr << "get_value<std::uint64_t>(" << n << ", index " << index << ") " << ex.what() << std::endl;
#endif
                    }
                    return make_object<std::uint64_t>(0);
                }

                template <> object get_value<float>(sqlite3_stmt *stmt, int index) {
                    auto const f = sqlite3_column_double(stmt, index);
                    try {
                        return make_object(boost::numeric::converter<float, double>::convert(f));
                    } catch (boost::bad_numeric_cast const ex) {
#ifdef _DEBUG_DB
                        std::cerr << "get_value<float>(" << f << ", index " << index << ") " << ex.what() << std::endl;
#endif
                    }
                    return make_object<float>(0.f);
                }

                template <> object get_value<double>(sqlite3_stmt *stmt, int index) {
                    return make_object<double>(sqlite3_column_double(stmt, index));
                }

                template <> object get_value<long double>(sqlite3_stmt *stmt, int index) {
                    return make_object<long double>(sqlite3_column_double(stmt, index));
                }

                template <> object get_value<std::string>(sqlite3_stmt *stmt, int index) {
                ...
                template <> object get_value<std::chrono::system_clock::time_point>(sqlite3_stmt *stmt, int index) {
                    const unsigned char *ptr = ::sqlite3_column_text(stmt, index);
                    if (ptr != NULL) {
                        int size = ::sqlite3_column_bytes(stmt, index);
                        const std::string result((const char *)ptr, size);
                ...
                template <> object get_value<std::chrono::nanoseconds>(sqlite3_stmt *stmt, int index) {
                    auto const n = ::sqlite3_column_int64(stmt, index);
                    return make_object(std::chrono::nanoseconds(n));
                }

                template <> object get_value<std::chrono::microseconds>(sqlite3_stmt *stmt, int index) {
                    auto const n = ::sqlite3_column_int64(stmt, index);
                    return make_object(std::chrono::microseconds(n));
                }

                template <> object get_value<std::chrono::milliseconds>(sqlite3_stmt *stmt, int index) {
                    auto const n = ::sqlite3_column_int64(stmt, index);
                    return make_object(std::chrono::milliseconds(n));
                }

                template <> object get_value<std::chrono::seconds>(sqlite3_stmt *stmt, int index) {
                    auto const n = ::sqlite3_column_int64(stmt, index);
                    return make_object(std::chrono::seconds(n));
                }

                template <> object get_value<std::chrono::minutes>(sqlite3_stmt *stmt, int index) {
                    auto const n = ::sqlite3_column_int64(stmt, index);
                    return make_object(std::chrono::minutes(n));
                }

                template <> object get_value<std::chrono::hours>(sqlite3_stmt *stmt, int index) {
                    auto const n = ::sqlite3_column_int64(stmt, index);
                ...
                template <> object get_value<version>(sqlite3_stmt *stmt, int index) {
                    auto const n = sqlite3_column_int(stmt, index);
                    try {
                        return make_object<version>(boost::numeric::converter<std::uint32_t, int>::convert(n));
                    } catch (boost::bad_numeric_cast const ex) {
#ifdef _DEBUG_DB
                        std::cerr << "get_value<version>(" << n << ", index " << index << ") " << ex.what() << std::endl;
#endif
                    }
                    return make_object<version>(0u);
                }

                template <> object get_value<revision>(sqlite3_stmt *stmt, int index) {
                    const auto result = boost::numeric_cast<std::uint64_t>(::sqlite3_column_int64(stmt, index));
                    return make_object<revision>(result);
                }

                template <> object get_value<buffer_t>(sqlite3_stmt *stmt, int index) {
                ...
                //	cyng::mac48
                template <> object get_value<mac48>(sqlite3_stmt *stmt, int index) {
                    const unsigned char *ptr = ::sqlite3_column_text(stmt, index);
                    if (ptr != NULL) {
                        int size = ::sqlite3_column_bytes(stmt, index);
                ...
                //	cyng::mac64
                template <> object get_value<mac64>(sqlite3_stmt *stmt, int index) {
                    const unsigned char *ptr = ::sqlite3_column_text(stmt, index);
                    if (ptr != NULL) {
                        int size = ::sqlite3_column_bytes(stmt, index);
                ...
                //	cyng::obis
                template <> object get_value<obis>(sqlite3_stmt *stmt, int index) {
                    auto const n = sqlite3_column_int64(stmt, index);
                    return make_object(make_obis(n));
                }

                //	crypto::digest_md5
                template <> object get_value<crypto::digest_md5>(sqlite3_stmt *stmt, int index) {
                    const unsigned char *ptr = ::sqlite3_column_text(stmt, index);
                    if (ptr != NULL) {
                        int size = ::sqlite3_column_bytes(stmt, index);
                ...
                //	crypto::digest_sha1
                template <> object get_value<crypto::digest_sha1>(sqlite3_stmt *stmt, int index) {
                    const unsigned char *ptr = ::sqlite3_column_text(stmt, index);
                    if (ptr != NULL) {
                        int size = ::sqlite3_column_bytes(stmt, index);
                ...
                template <> object get_value<crypto::digest_sha256>(sqlite3_stmt *stmt, int index) {
                    const unsigned char *ptr = ::sqlite3_column_text(stmt, index);
                    if (ptr != NULL) {
                        int size = ::sqlite3_column_bytes(stmt, index);
                ...
                template <> object get_value<crypto::digest_sha512>(sqlite3_stmt *stmt, int index) {
                    const unsigned char *ptr = ::sqlite3_column_text(stmt, index);
                    if (ptr != NULL) {
                        int size = ::sqlite3_column_bytes(stmt, index);
                ...
                //	crypto::aes_128_key
                template <> object get_value<crypto::aes_128_key>(sqlite3_stmt *stmt, int index) {
                    const unsigned char *ptr = ::sqlite3_column_text(stmt, index);
                    if (ptr != NULL) {
                        int size = ::sqlite3_column_bytes(stmt, index);
                ...
                //	crypto::aes_192_key
                template <> object get_value<crypto::aes_192_key>(sqlite3_stmt *stmt, int index) {
                    const unsigned char *ptr = ::sqlite3_column_text(stmt, index);
                    if (ptr != NULL) {
                        int size = ::sqlite3_column_bytes(stmt, index);
                ...
                //	crypto::aes_256_key
                template <> object get_value<crypto::aes_256_key>(sqlite3_stmt *stmt, int index) {
                    const unsigned char *ptr = ::sqlite3_column_text(stmt, index);
                    if (ptr != NULL) {
                        int size = ::sqlite3_column_bytes(stmt, index);
                ...
                //	cyng::attr_map_t
                template <> object get_value<attr_map_t>(sqlite3_stmt *stmt, int index) {
                    const unsigned char *ptr = ::sqlite3_column_text(stmt, index);
                    if (ptr != NULL) {
                        int size = ::sqlite3_column_bytes(stmt, index);
                        std::string result;
                ...
                //	param_map_t
                template <> object get_value<param_map_t>(sqlite3_stmt *stmt, int index) {
                    const unsigned char *ptr = ::sqlite3_column_text(stmt, index);
                    if (ptr != NULL) {
                ...
                template <> object get_value<boost::uuids::uuid>(sqlite3_stmt *stmt, int index) {
                    const unsigned char *ptr = ::sqlite3_column_text(stmt, index);
                    if (ptr != NULL) {
                        int size = ::sqlite3_column_bytes(stmt, index);
                ...
                template <> object get_value<std::filesystem::path>(sqlite3_stmt *stmt, int index) {
                    const unsigned char *ptr = ::sqlite3_column_text(stmt, index);
                    if (ptr != NULL) {
                        int size = ::sqlite3_column_bytes(stmt, index);
                        const std::string str((const char *)ptr, size);
                ...
                template <> object get_value<boost::asio::ip::address>(sqlite3_stmt *stmt, int index) {
                    const unsigned char *ptr = ::sqlite3_column_text(stmt, index);
                    if (ptr != NULL) {
                        int size = ::sqlite3_column_bytes(stmt, index);
                        const std::string str((const char *)ptr, size);
                ...
                template <> object get_value<boost::asio::ip::tcp::endpoint>(sqlite3_stmt *stmt, int index) {
                    const unsigned char *ptr = ::sqlite3_column_text(stmt, index);
                    if (ptr != NULL) {
                        int size = ::sqlite3_column_bytes(stmt, index);
                        const std::string str((const char *)ptr, size);
                        ...
                        // if (vec.size() == 2) {
                        //
                        //	return make_object(boost::asio::ip::tcp::endpoint(boost::asio::ip::make_address(vec.at(0)),
                        // std::stoul(vec.at(1))));
                        //}
                    }
            ...
            std::size_t sqlite_result::column_count() { return ::sqlite3_column_count(*statement_); }
