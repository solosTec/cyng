...
namespace cyng {
    namespace io {
        ...
        std::size_t serializer<std::uint8_t, CPP>::write(std::ostream &os, std::uint8_t v) {
            ...
            os << "static_cast<std::int8_t>( 0x" << std::hex << +v << " )";
            ;
        ...
        std::size_t serializer<std::uint16_t, CPP>::write(std::ostream &os, std::uint16_t v) {
            ...
            os << "static_cast<std::uint16_t>( 0x" << std::hex << v << " )";
        ...
        std::size_t serializer<std::uint32_t, CPP>::write(std::ostream &os, std::uint32_t v) {
            ...
            os << "static_cast<std::uint32_t>( 0x" << std::hex << v << " )";
        ...
        std::size_t serializer<std::uint64_t, CPP>::write(std::ostream &os, std::uint64_t v) {
            ...
            os << "static_cast<std::uint64_t>( 0x" << std::hex << v << " )";
        ...
        std::size_t serializer<double, CPP>::write(std::ostream &os, double v) {
            ...
            os << "static_cast<std::uint64_t>( 0x" << std::fixed << v << " )";
        ...
        std::size_t serializer<boost::uuids::uuid, CPP>::write(std::ostream &os, boost::uuids::uuid const &v) {
            calc_size const cs(os);
            os << "boost::uuids::uuid::string_generator()(" << boost::uuids::to_string(v) << ")";
            return cs;
        }
        ...
        std::size_t serializer<vector_t, CPP>::write(std::ostream &os, vector_t const &vec) {
            ...
            for (auto const &obj : vec) {
                ...
                switch (tag) {
                case TC_ATTR:
                case TC_PARAM: serialize_cpp(os, obj); break;
                default: serialize_cpp(os, obj);
                }
            }
        ...
        std::size_t serializer<param_t, CPP>::write(std::ostream &os, param_t const &param) {
            ...
            os << "cyng::make_param(" << '"' << param.first << '"' << ',' << ' ';

            auto const tag = param.second.tag();
            switch (tag) {
            case TC_ATTR:
            case TC_PARAM: serialize_cpp(os, param.second); break;
            default: serialize_cpp(os, param.second);
            }
        ...
        // std::size_t serializer <std::chrono::system_clock::time_point, CPP>::write(std::ostream& os,
