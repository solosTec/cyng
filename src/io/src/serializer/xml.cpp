...
namespace cyng {
    namespace io {
        ...
        bool serializer<bool, XML>::write(pugi::xml_node node, bool v) {
            ...
            return (v) ? node.append_child(pugi::node_pcdata).set_value("true")
        ...
        bool serializer<buffer_t, XML>::write(pugi::xml_node node, buffer_t const &v) {
            ...
            auto const str = cyng::io::to_hex(v);
        ...
        bool serializer<char, XML>::write(pugi::xml_node node, char v) {
            ...
            auto const str = std::to_string(+v);
            return node.append_child(pugi::node_pcdata).set_value(str.c_str());
        }
        ...
        bool serializer<std::chrono::system_clock::time_point, XML>::write(
            pugi::xml_node node,
        ...
        bool serializer<vector_t, XML>::write(pugi::xml_node node, vector_t const &v) {
            ...
            for (auto const &obj : v) {
                ...
                case type_code::TC_PARAM: serialize<XML>::write(node, obj); break;
                default: serialize<XML>::write(node.append_child("value"), obj); break;
                }
                ++index;
            }
            return true;
        ...
        bool serializer<tuple_t, XML>::write(pugi::xml_node node, tuple_t const &v) {
            ...
            //
            std::stringstream ss;
            ss << cyng::intrinsic_name<tuple_t>() << '_' << std::hex << std::hash<uintptr_t>()(reinterpret_cast<uintptr_t>(&v));
            ...
            if (v.size() > 1) {
                for (auto const &obj : v) {
                    ...
                    case TC_DEQUE:
                    case TC_ATTR_MAP:
                    case TC_PARAM_MAP: serialize<XML>::write(node.append_child(type_name.c_str()), obj); break;
                    case type_code::TC_PARAM: serialize<XML>::write(node, obj); break;
                    default: serialize<XML>::write(node.append_child("value"), obj); break;
                    }
                }
                ...
                case TC_DEQUE:
                case TC_ATTR_MAP:
                case TC_PARAM_MAP: serialize<XML>::write(node.append_child(type_name.c_str()), v.front()); break;
                case type_code::TC_PARAM: serialize<XML>::write(node, v.front()); break;
                default: serialize<XML>::write(node.append_child("value"), v.front()); break;
                }
            }
            return true;
        }

        bool serializer<deque_t, XML>::write(pugi::xml_node, deque_t const &v) { return false; }
