    ...
    namespace sql {
        dialect get_dialect(std::string const &name) {
            if (boost::algorithm::iequals(name, "MYSQL")) {
                ...
                boost::algorithm::iequals(name, "SQLSERVER") || boost::algorithm::iequals(name, "MSSQLServer") ||
                boost::algorithm::iequals(name, "MSSQL")) {
                return dialect::SQLSERVER;
            } else if (
                boost::algorithm::iequals(name, "POSTGRESQL") || boost::algorithm::iequals(name, "POSTGRES") ||
        ...
        std::string get_field_type(dialect d, type_code code, std::size_t width) {
            ...
            case dialect::MYSQL:
                ...
                case TC_TIME_POINT:
                    return "DATETIME"; //	'1000-01-01 00:00:00' to '9999-12-31 23:59:59' ('YYYY-MM-DD HH:MM:SS')
                ...
                case TC_FS_PATH: BOOST_ASSERT(width == 1024 || width == -1); return "VARCHAR(1024)";
                case TC_EC:
                    return "INT UNSIGNED";
            ...
            case dialect::SQLITE:
                ...
                case TC_DATE: return "FLOAT";       //	stored as julianday (select julianday('2011-03-20', 'utc');)
