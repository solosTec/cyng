 ...
 * 
 */ 
#ifndef CYNG_TABLE_BODY_HPP
#define CYNG_TABLE_BODY_HPP
...
namespace cyng 
{
	namespace table 
	{
		 ...
		 *	example:
		 *	@code
		 const cyng::table::data_type key = cyng::store::data_generator( "1", 2, std::chrono::seconds(3));
		 *	@endcode
		 */
